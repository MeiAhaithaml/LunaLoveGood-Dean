...
import '../saudangnhap/Product_Page/best_page.dart';
import '../sign_in.dart';
...
class HomePageFirst extends StatefulWidget {
  ...
  @override
  State<HomePageFirst> createState() => _HomePageState();
}

class _HomePageState extends State<HomePageFirst> {
  @override
                ...
                showDialog(
                  ...
                  builder: (BuildContext context) {
                    return AlertDialog(
                      ...
                      content: const Text('Bạn cần đăng nhập để thực hiện tính năng này.'),
                      actions: [
                        TextButton(
                          onPressed: () {
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      if (dataSnapShot.data!.length > 20)
                        Container(
                          width: 339,
                          height: 40,
                          decoration: BoxDecoration(
